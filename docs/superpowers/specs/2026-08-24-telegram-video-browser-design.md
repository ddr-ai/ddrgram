...
- Repo: `ddrgram`, published as a **project GitHub Pages** site at `https://ddr-ai.github.io/ddrgram/` (same pattern as [ddr-anime](https://ddr-ai.github.io/ddr-anime/)).
- Vite `base` is `/ddrgram/` so assets resolve under the repo path.
