...
import { d as init_dist, f as process$1, u as require_react } from "../_libs/@floating-ui/react-dom+[...].mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BMw7-Vjv.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DflTDkwd.mjs").then((n) => n.t),
		import("./start-DzcWAbAE.mjs"),
		import("./empty-plugin-adapters-B6jY355V.mjs")
	]);
	return {
		routerEntry,
		startEntry,
...
var IS_PRERENDERING = process$1.env.TSS_PRERENDERING === "true";
var IS_SHELL_ENV = process$1.env.TSS_SHELL === "true";
var IS_DEV = false;
...
//#endregion
export { createServerEntry, server_default as default, ssr_exports as n, __exportAll as t };
